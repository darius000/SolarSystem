...
class Scene extends THREE.Scene {
    constructor() {
        super();
        this.m_Camera = new CameraAim(75.0, Application.m_AspectRatio, .0001, 20000);
    }
...
class Controls {
    constructor(camera = new CameraAim(75, 16 / 9, .01, 1000)) {
        ...
        document.getElementById('Controls').appendChild(this.m_Gui3.domElement);
    ...
    CreateGUI() {
        ...
        this.m_Controls.add(this.m_Camera, "mRotationSteps", 0.00001, 10.0).name("RotationSteps");
